...
const navItems = [
    { to: ".", label: "Thống kê lớp học", icon: ChartBar, end: true },
    { to: "classes", label: "Học sinh của tôi", icon: Users },
    { to: "schedule", label: "Lịch dạy", icon: CalendarBlank },
    { to: "documents", label: "Tài liệu", icon: Files },
    { to: "tests", label: "Đề kiểm tra", icon: ClipboardText },
];
